...
<div class="container-fluid">
    <a class="btn btn-success float-right" href="<?php echo base_url(); ?>admin/about/about_key_differentiators">Back</a>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <form role="Form" method="post" action="<?php echo base_url(); ?>admin/about/about_key_differentiators_update/<?php echo $key->id; ?>" accept-charset="UTF-8" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="fname">Silder Image</label>
                    <span class="text-danger"></span>

                    <input type="file" id="image" class="form-control" name="image" placeholder="" value="">
                    <img class="thumbnail" style="height: 50px; width: 50px;" src="<?php echo base_url(); ?>uploads/<?php echo $key->image ?>" alt="">
                </div>
                <div class="form-group">
                    <label for="text">Text Line </label>
                    <span class="text-danger"><?php echo form_error('text'); ?></span>
                    <input type="text" id="text" name="text" class="form-control" value="<?php echo $key->text_line ?>">
                </div>
                <div class="form-group">
                    <label for="description">Description </label>
                    <span class="text-danger"><?php echo form_error('description'); ?></span>
                    <textarea id="description" name="description" cols="40" rows="10" class="form-control" value="<? echo $key->description ?>"></textarea>
                </div>
