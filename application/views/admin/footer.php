 <!-- Footer -->
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
           ...
           <span>Intelligence Systems</span>. All rights reserved. | Designed by <a href="http://thecolourmoon.com/" target="_blank">ColourMoon Technologies</a>
         </p>          
    </div>
        </div>
      </footer>
  ...
  <!-- Page level plugins -->
  <script src="<?php echo base_url(); ?>adminassests/vendor/chart.js/Chart.min.js"></script>

  <!-- Page level custom scripts -->
  <script src="<?php echo base_url(); ?>adminassests/js/demo/chart-area-demo.js"></script>
  <script src="<?php echo base_url(); ?>adminassests/js/demo/chart-pie-demo.js"></script>
